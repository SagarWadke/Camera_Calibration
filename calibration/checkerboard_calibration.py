from calibration.objp_imgp_utils import checker_objp_imgp
import cv2 as cv
...
def main():
    ...
    objpoints, imgpoints, images = checker_objp_imgp(chessboardSize, size_of_chessboard_squares_mm,image_format)
